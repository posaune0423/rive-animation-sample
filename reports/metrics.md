...
Generated 2026-09-13T07:23:56.513Z by `bun run e2e` (Playwright, Chromium, iPhone 14 viewport).
...
| wasm fetch + compile | 57 ms |
| first Rive instance ready | 14 ms |
| replay latency (trigger → first advance) | 12.9 ms |
...
| sparkling | T2 | chatTop | 7.6 | 66 | 3.9 |
| plush | T2 | chatTop | 7.0 | 66 | - |
| bouquet | T3 | center | 27.7 | 66 | 16.9 |
| perfume | T3 | center | 14.4 | 66 | 20.7 |
| ring | T3 | center | 272.5 | 67 | - |
| diamond | T4 | full | 126.4 | 67 | 10.0 |
| suite | T4 | full | 29.5 | 67 | - |
